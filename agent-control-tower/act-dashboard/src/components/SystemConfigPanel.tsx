...
const CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    keys: [
      { key: 'report.generate.max.tokens', label: 'Generate Max Tokens', min: 4096, max: 131072, step: 1024 },
      { key: 'report.amend.max.tokens', label: 'Amend Max Tokens', min: 4096, max: 131072, step: 1024 },
    ],
  },
];
