...
- Pre-installs the [opencode](https://opencode.ai) CLI (official npm package `@opencode-ai/cli`,
  v1.18.x) so each agent sandbox can run `opencode serve --hostname 0.0.0.0 --port 4096`.
