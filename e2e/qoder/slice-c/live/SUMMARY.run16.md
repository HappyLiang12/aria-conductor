# qoder slice-c harness summary (run 16)
...
- finished: 2026-09-18T22:36:07Z

| step | log | status |
|------|-----|--------|
| preflight | preflight.run18.log | PASS |
| rebuild-image | — | SKIPPED |
| S1 | — | SKIPPED |
| S2 | — | SKIPPED |
| S3 | — | SKIPPED |
| S4 | S4.run12.log | FAIL |
| S5 | — | SKIPPED |
| S6 | — | SKIPPED |
| S7 | — | SKIPPED |
| S8 | — | SKIPPED |
...
| leak-scan | leak-scan.run16.log | PASS |

- executed: 2 pass, 1 fail, 18 skipped (of 21 in plan)
- PAT leak scan: 0 hits across 319 evidence file(s)
