# qoder slice-c harness summary (run 5)
...
| step | log | status |
|------|-----|--------|
| preflight | preflight.run6.log | PASS |
...
| S8 | — | SKIPPED |
| S9 | — | SKIPPED |
| S10 | S10.run6.log | PASS |
| S11 | S11.run6.log | FAIL |
| S12 | S12.run7.log | FAIL |
...
| leak-scan | leak-scan.run6.log | PASS |

- executed: 3 pass, 2 fail, 16 skipped (of 21 in plan)
