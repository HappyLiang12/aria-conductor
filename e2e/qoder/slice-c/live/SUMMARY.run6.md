# qoder slice-c harness summary (run 6)
...
- finished: 2026-09-18T12:08:33Z

| step | log | status |
|------|-----|--------|
| preflight | preflight.run7.log | PASS |
...
| S8 | — | SKIPPED |
| S9 | — | SKIPPED |
| S10 | S10.run7.log | FAIL |
| S11 | S11.run7.log | FAIL |
| S12 | S12.run6.log | FAIL |
...
| leak-scan | leak-scan.run5.log | PASS |

- executed: 2 pass, 3 fail, 16 skipped (of 21 in plan)
- PAT leak scan: 0 hits across 164 evidence file(s)
