# qoder slice-c harness summary (run 8)
...
- flags: dry-run=0 skip-regression=0 rebuild-image=0 no-preflight=0 only=S11
- finished: 2026-09-18T12:50:11Z

| step | log | status |
|------|-----|--------|
| preflight | preflight.run9.log | PASS |
...
| leak-scan | leak-scan.run8.log | PASS |

- executed: 3 pass, 0 fail, 18 skipped (of 21 in plan)
- PAT leak scan: 0 hits across 186 evidence file(s)
